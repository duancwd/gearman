...
public class ClientAppNoteDay {
    private ClientAppNoteDay() { }
 ...
 public static Runnable showTimer() {
        TimerTask task1 = new TimerTask() {
            ...
            System.out.println("flag=1 = " + flag);
                ...
                ++count;
                System.out.println("Send App notification everyday 时间=" + new Date() + " 执行了" + count + "次"); // 1次
            }
        ...
        try {
            ...
            while(flag ==1)
            {
                ...
                try {
                	...
                	byte[] App = client.submitJob("TimeAppnDayG", data, JobPriority.NORMAL);
                	 flag =2;
                	 System.err.println("Appnoteeveryday: " + new String(App));
