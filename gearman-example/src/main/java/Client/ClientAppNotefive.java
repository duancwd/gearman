...
public class ClientAppNotefive {
    private ClientAppNotefive() { }
 ...
 public static Runnable showTimer() {
        TimerTask task1 = new TimerTask() {
            ...
            System.out.println("flag=1 = " + flag);
                ...
                ++count;
                System.out.println("Send App note 时间=" + new Date() + " 执行了" + count + "次"); // 1次
            }
        ...
        try {
            ...
            while(flag ==1)
            {
                ...
                try {
                	...
                	byte[] App = client.submitJob("TimeAppnfiveG", data, JobPriority.NORMAL);
                	 flag =2;
                	 System.err.println("App: " + new String(App));
