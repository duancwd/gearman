 ...
 public static Runnable showTimer() {
        TimerTask task1 = new TimerTask() {
            ...
            System.out.println("flag=1 = " + flag);
                ...
                ++count;
                System.out.println("backup  时间=" + new Date() + " 执行了" + count + "次"); // 1次
            }
    ...
    public static Runnable submission() throws IOException{
        ...
        try {
            byte data[] = "TimeEmailfive".getBytes();
            ...
            while(flag ==1)
            {
                ...
                try {
                	...
                	byte[] backup = client.submitJob("BackupTaskG", data, JobPriority.NORMAL);
                	System.err.println("backup: " + new String(backup));
                	 flag =2;
